  ...
  <?php if ( have_comments() ) : ?>
    <div id="comments">
		...
		<h2 id="comments-title">
			<?php
				printf( _n( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'achwptheme' ),
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'achwptheme' ); ?></p>
	<?php endif; ?>
